	...
	return (
		<div className="flex min-h-screen p-4 md:p-10 flex-col items-center justify-between">
			...
			<div className="flex flex-col items-center md:-mt-16">
				<div>
					<svg className="-mb-24 md:-mb-52" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 157.027 157.031">
						<defs>
							<linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="87.172%">
					...
					<h1 className={`text-center text-4xl md:text-7xl ${rocaTwo.className}`}>
						Welcome to{' '}
						<span className={`font-black text-5xl md:text-8xl ${darkerGrotesque.className}`}>Dyson</span>
					</h1>
					<p className="mt-3 text-xl text-center text-neutral-500 max-w-md mx-auto">
			...
			<div className="max-w-md mx-auto flex flex-col items-center space-y-4 md:space-y-6">
				<svg
